...
- Added uncertainty scores for reconstructed alleles: UNC values close to 1/12 (~0.08) present higher confidence of the reconstructed ancestral allele, values close to 1/2 (0.5) present lower confidence of the ancestral allele, due to mutability and/or lack of data during Ancestral State Reconstruction. 
